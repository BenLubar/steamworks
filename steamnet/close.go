...
func CloseChannel(user steamworks.SteamID, channel int) bool {
	return internal.ISteamNetworking_CloseP2PChannelWithUser(internal.SteamID(user), channel)
}
...
func CloseAllChannels(user steamworks.SteamID) bool {
	return internal.ISteamNetworking_CloseP2PSessionWithUser(internal.SteamID(user))
}
